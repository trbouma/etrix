import click
from openetr.commands.core import alias_group, bootstrap, get_bitcoin_info, get_object_id, info, init_config, migrate_config, profile_group, send_bitcoin, set_config, trivia, validate, version, whoami
